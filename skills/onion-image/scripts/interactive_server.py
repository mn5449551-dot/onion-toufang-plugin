  ...
  <main>
    ...
    <aside class="panel">
      ...
      <div class="field">
        ...
        <div class="hint">不要在 HTML 里上传。需要界面或功能截图时，直接在 Codex 对话里上传，Agent 会把它作为参考图加入本次生图。</div>
      </div>
      <div class="field">
  ...
  <script>
    ...
    function collectResult() {
      ...
      return {
        ...
        ui_reference: "codex_upload_only",
        ui_reference_note: "界面/功能参考图不要在 HTML 中上传；需要时直接在 Codex 对话里传截图。",
    ...
    function renderAll() {
      ...
      renderControls();
      renderSummary();
      ["sets", "fontEnabled", "cta", "notes"].forEach(id => {
